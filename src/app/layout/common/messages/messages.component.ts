...
export class MessagesComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._messagesService.messages$
            ...
            .subscribe((messages: any[]) => {
                ...
                // Load the messages
                this.messages = messages.filter(message => message.recieverId == this.user.id);
    ...
    private _calculateUnreadCount(): void
    {
        ...
        {
            count = this.messages.filter(message => message.recieverId == this.user.id && message.isRead==false).length;
        }
